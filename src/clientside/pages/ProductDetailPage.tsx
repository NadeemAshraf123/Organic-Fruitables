...
const ProductDetailPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 mt-50">
      
      <div className="max-w-7xl mx-auto px-4 mb-8">
        <h1 className="text-4xl text-center font-bold text-gray-900 border-b-2 border-[#FDC700] pb-4">
          {product.name}
        </h1>
      </div>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-8/12 flex items-center justify-center">
            <img
              ...
              alt={product.name}
              className="w-full h-150 object-contain rounded-lg"
            />
          </div>
          ...
          <div className="md:w-4/12 space-y-6">
            ...
            <button
              ...
              className="bg-[#FDC700] hover:bg-yellow-500 text-white font-medium py-3 px-6 rounded-lg transition-colors w-full"
            >
              Add to Cart
            </button>
          </div>
