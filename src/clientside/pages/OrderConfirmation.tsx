                  ...
                  {undeliveredOrders.length > 0 && (
                    <div className="bg-green-100 p-3 rounded-lg mt-3">
                      ...
                      <ul className="list-disc pl-6 text-left text-green-700">
                        {undeliveredOrders[undeliveredOrders.length - 1].items.map((item: any) => (
                          <li key={item.id}>
                      ...
                      <p className="mt-2 font-semibold text-green-800">
                        Total: ${fmt(undeliveredOrders[undeliveredOrders.length - 1].total)}
                      </p>
                      <p className="text-sm text-green-600 mt-1">
                        Placed at:{" "}
                        {new Date(
                          undeliveredOrders[undeliveredOrders.length - 1].createdAt
                        ).toLocaleString()}
                      </p>
                    </div>
                  )}
