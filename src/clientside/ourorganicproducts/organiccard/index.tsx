...
const OurOrganicProductsCard: React.FC<ProductCardProps> = ({
  id,
  name,
  image,
  category,
      ...
      <div className="p-4 space-y">
        ...
        <div className="flex flex-row gap-10 md:flex-col items-center mt-4">
          ...
          <button
            ...
            type="button"
            className="rounded-full border border-amber-400 px-3 py-1 text-[#81C408] 
              hover:bg-[#FFB524] hover:text-[#FFFFFF] focus:outline-none focus:ring-4 focus:ring-amber-200"
          >
