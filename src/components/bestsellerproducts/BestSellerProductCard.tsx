    ...
    // <div className=''>
      ...
      <div className="">
        ...
        <div className=" mt-10 md:p-4 ml-4 md:ml-0 md:mt-20  lg:mt-0">
          <h3 className="text-[20px] md:text-[20px] font-sans font-lightbold text-gray-500 leading-tight">{product.name}</h3>
          <Rating rating={product.rating} className="mt-2 sm:mt-2 md:mt-2 text-gray-500" />
          <div className="mt-2 sm:mt-3 md:mt-2 text-1xl font-serif md:text-[22px] font-semibold text-[#747d88]">
            {product.price.toFixed(2)} <span className=" mt-2 text-1xl md:text-[30px] font-serif align-middle">$</span>
          </div>
